...
namespace BonkSurvivor
{
    ...
    public sealed partial class SurvivorGame : MonoBehaviour
    {
        ...
        public void ResetRun()
        {
            ...
            ResetProgression(); notice = "Valitse aloitusase"; noticeUntil = 5; UpdateCamera(true);
        }
        ...
        void Update()
        {
            ...
            for (int i = enemies.Count - 1; i >= 0; i--)
            {
                ...
                {
                    Health = Mathf.Max(0, Health - Mathf.Max(1, (e.elite ? 18 : 9) - Armor)); invulnerability = .65f;
        ...
        void SpawnEnemy()
        {
            ...
            enemies.Add(new Enemy {
                ...
                health = (elite ? 85 : 24) * (1 + Elapsed / 240) * curse * (1 + .3f * (Area - 1)), speed = ((elite ? 2.2f : 3.1f) + Mathf.Min(2, Elapsed / 120)) * curse, elite = elite
            });
        }
        ...
        {
            if (Random.value < CritChance) amount *= 2; e.health -= amount;
        ...
        void OnGUI()
        {
            ...
            GUI.Label(new Rect(24,664,1000,35), "WASD / nuolet  Liiku     •     Hyökkäys automaattinen     •     E  Tutki     •     TAB  Kauppa / tauko", textStyle);
            ...
            if ((ShopOpen || Finished) && !Selecting && PendingChoices == 0)
            {
                ...
                if (Finished)
                {
                    ...
                    GUI.Label(new Rect(380,305,520,40), "+" + EarnedSilver + " Silver tältä kierrokselta", textStyle);
                    DrawLegacy(380, 460);
