...
namespace BonkSurvivor
{
    public sealed partial class SurvivorGame
    {
        ...
        static readonly string[] UpgradeNames = {
            "Sword / Miekka", "Bow / Jousi", "Lightning / Salamasauva",
        ...
        static readonly string[] UpgradeDetails = {
            "Uusi ase tai +1 asetaso. Leveä automaattinen sivallus.",
            ...
            "+1 nuoli, salamakohde tai miekan lisäisku (enintään 6).", "+20 % miekan kantamaa ja nuolten osumakokoa.",
        ...
        void TickProgression(float dt)
        {
            ...
            if (boss != null)
            {
                ...
                if (bossAttackTimer <= 0)
                {
                    ...
                    { Health = Mathf.Max(0, Health - Mathf.Max(1, 22 - Armor)); if (Health <= 0) FinishRun(); }
        ...
        {
            string weapons = ""; foreach (var w in weaponLevels) weapons += w.Key + " " + w.Value + "   ";
